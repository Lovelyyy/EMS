...
@section('main-content')
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4><i class="fa fa-plus fa-fw"></i>Add Employee</h4>
		</div>
		<div class="panel-body">
			<form class="form-horizontal" role="form" method="POST" action="{{ url('/')}}/employee/create">
			    		...
			    		<select id="position" name="position" class="form-control">
			    			@foreach($positions as $position)
			    				<option 
			    					...
			    					<?php if(old('position') == $position->position_id) echo "selected"; ?>> 
				...
				<div class="form-group{{ $errors->has('Employee_Number') ? ' has-error' : '' }} required">
					<label for="employee_no" class="col-md-2 control-label">Employee Number</label>
					<div class="col-md-10">
			    		<input id="employee_no" type="text" class="form-control" name="Employee_Number" value="{{ old('Employee_Number') }}">
				...
				<div class="form-group{{ $errors->has('Email_Address') ? ' has-error' : '' }} required">
					<label for="email" class="col-md-2 control-label">Email Address</label>
					<div class="col-md-10">
			    		<input id="email" type="email" class="form-control" name="Email_Address" value="{{ old('Email_Address') }}">
